  ...
  Widget build(BuildContext context) {
    return Card(
      ...
      child: ExpansionTile(
        ...
        children: [
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text10
          ...
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text16, Icons.line_weight, character.weight.toString(),
              Colors.white),
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text17, Icons.accessibility_new, character.size,
              Colors.white),
          _buildStatItem(
              AppLocalizations.of(context)!.cards_dnd_text18, Icons.emoji_emotions, character.traits.join(', '), Colors.white),
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text19, Icons.language, character.languages.join(', '),
              Colors.white),
          ...
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text22, Icons.casino,
          ...
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text24, Icons.backpack, character.tools.join(', '),
              Colors.white),
          ...
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text27, Icons.book,
          ...
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text29, Icons.brush, character.hairColor,
              Colors.white),
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text30, Icons.face, character.skinColor,
              Colors.white),
          _buildStatItem(AppLocalizations.of(context)!.cards_dnd_text31, Icons.emoji_people, character.appearance, Colors.white),
        ],
      ),
    );
  }

...
// class ProfileAliensCharacterCard extends StatelessWidget {
//   final AliensCharacter character;

//   ProfileAliensCharacterCard({super.key, required this.character});
        ...
        trailing: Row(
          ...
          children: [
            IconButton(
              ...
              onPressed: () {
                firebase.updateCharacter(widget.character.toMap());
              },
            ),
            IconButton(
              icon: const Icon(
              ...
              onPressed: () {
                ...
                print("delete");
                firebase.deleteCharacter(widget.character.toMap());
              },
            ),
            Icon(

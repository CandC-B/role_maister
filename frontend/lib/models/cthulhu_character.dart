...
class CthulhuCharacter extends Character {
  ...
  static Map<String, int> _getRandomSkills(
      Map<String, int> characteristics, String occupation) {
    ...
    if (occupation == 'Antiquarian') {
      ...
      Map<String, int> extras = _getExtraRandomSkills(characteristics, 1,
          ["Natural World", "Occult"], skills['Writer']!.keys.toList());
      extras.forEach((skill, prob) {
      ...
      extras = _getExtraRandomSkills(characteristics, 0,
          ["Art/Craft", "Disguise"], skills['Police inspector']!.keys.toList());
      extras.forEach((skill, prob) {
        skills['Police inspector']![skill] = prob;
      });
      extras = _getExtraRandomSkills(
  ...
  static Map<String, int> _getExtraRandomSkills(
      Map<String, int> characteristics,
      int extraNum,
  ...
  static Map<String, int> _getRandomWeapons(
      int bonus, Map<String, int> skills) {
    ...
    Map<String, int> weapons = {"Brawl": makeRoll(1, 3) + bonus};
  ...
  static fromMap(Map<String, dynamic> statsData) {
    print(statsData as Map<String, dynamic>);
    return CthulhuCharacter(
